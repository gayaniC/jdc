            ...
            <div class="box round first grid">
                ...
                <div class="block">
                 ...
                 <tr>
                    ...
                    <td><?php echo form_label('Task','task_id'); ?></td>
                    <td><?php echo form_dropdown('task_id',$tsk,$this->input->get('task_id')) ?></td>
                 </tr>
                 <tr>
                 <td><?php echo form_label('Date','applied_on'); ?></td>
                    ...
                    <td><?php 
					$app = array(''=>'All','A'=>'Approved','R'=>'Reject','N'=>'Never');
                    ...
                    <tr>
                    <td><?php echo form_label('Completion status','com_status') ?></td>
                    <td>
                    <?php 
                    $comp_status = array(''=>'All','1'=>'Completed','A'=>'Not Completed','9'=>'Half completed');
                    echo form_dropdown('com_status',$comp_status,$this->input->post('com_status'));
                    ?>
                    </td>
                    ...
                    <tr>
                    <td><?php 
					echo form_hidden('report_type','Progress');
