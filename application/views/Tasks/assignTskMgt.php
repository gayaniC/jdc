        ...
        <div class="grid_10">
            ...
            <?php // echo '<pre>'; print_r($super); echo '</pre>';?>
                ...
                <?php echo form_open('performance_ctr/validate_task');?>
                    ...
                    <?php echo form_hidden('supervisor_id',set_value('supervisor_id',$result_super['supervisor_id'])); ?>
                     <?php if($action != 'Add'){ ?>
                    <?php echo form_hidden('task_id',set_value('task_id',$result['task_id'])); ?>
                    <?php } ?>
					<?php echo form_input('supervisor_id',set_value('supervisor_id',$result_super['supervisor_id']),'class="mini"'.$add);?>
                    </td>
                    </tr>
                    ...
                    <td>
                    	<?php 
						echo form_input('Emp_id',set_value('Emp_id',$result_super['First_name']),'class="mini" '.$add);
						 ?>
